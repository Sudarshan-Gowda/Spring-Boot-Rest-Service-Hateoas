...
public class EmployeeServiceImpl implements IEmployeeService {
	 ...
	 */
	@Override
	public EntityModel<Employee> getEmployeeById(int empId) {
		...
		EntityModel<Employee> model = new EntityModel<Employee>(employee);
		WebMvcLinkBuilder linkTo = linkTo(methodOn(EmployeeController.class).retrieveAllEmployees());
